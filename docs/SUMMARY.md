...
- [Architecture Decision Records](architecture-decisions/README.md)
  - [ADR 001: Code Structure and Patterns](architecture-decisions/001-code-structure-and-patterns.md)
  - [ADR 002: Frontend Stack Selection](architecture-decisions/002-frontend-stack-selection.md)
  - [ADR 011: IPC Error Sanitisation and Redaction](architecture-decisions/011-ipc-error-sanitisation.md)
