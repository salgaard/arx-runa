...
7. **Strong revocation (key rotation)** — *Removed*: re-encryption does not enforce revocation because a recipient can retain plaintext during the download window. Not implemented.
