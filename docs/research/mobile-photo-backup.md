...
| **Apple Developer** | `URLSessionConfiguration.background(withIdentifier:)` — official background transfer API | [developer.apple.com/documentation/foundation/urlsessionconfiguration/background(withidentifier:)](https://developer.apple.com/documentation/foundation/urlsessionconfiguration/background\(withidentifier:\)) |
