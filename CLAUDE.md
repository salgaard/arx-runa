...
Contract anchors: each phase `design.md` `## Contract Surface` section is canonical; sub-phases should reference it instead of duplicating command/schema/wire contracts.
