...
flowchart TD
    subgraph BACKEND ["Rust Backend (src-tauri/src/)"]
        ...
        SHARING["sharing/<br/>HPKE, contacts,<br/>share packages"]:::feature
    ...
    SHARING -->|"per-file keys<br/>HPKE envelope"| CRYPTO
...
3. **Feature** (purple): `sharing/` — file sharing via HPKE. Depends on crypto and storage. Cloud access goes through storage abstraction.
