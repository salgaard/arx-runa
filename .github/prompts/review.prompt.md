...
messages:
  ...
  - role: user
    content: |
      ...
      5. Check ADR coverage: list any architectural decisions referenced in
         recent commits that lack a corresponding file in
         `docs/architecture-decisions/`. Flag these as ADR gaps.
      6. Produce a merge readiness summary:
