...
task(agent_type="report-writer",        model="claude-opus-4.6",   ...)    → REPORT_WRITER_RESULT
```
...
| `report-writer` | `claude-opus-4.6` | Final report assembly requires synthesizing all findings with high fidelity |
