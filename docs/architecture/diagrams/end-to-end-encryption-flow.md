...
sequenceDiagram
    ...
    Note right of Crypto: info: "voidgate-key-encryption"<br/>info: "voidgate-sqlcipher"<br/>info: "voidgate-manifest-backup"
    ...
    loop Each chunk (4 MiB)
        ...
        Note right of Crypto: AAD = file_id (16B) || chunk_index (4B BE)<br/>Nonce = 24B CSPRNG
    ...
    loop Each chunk
        ...
        Storage->>Storage: Verify BLAKE3 (fail fast if mismatch)
