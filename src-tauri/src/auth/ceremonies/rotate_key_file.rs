...
mod tests {
    ...
    use crate::auth::staging;
    use crate::auth::{SetupRecoveryRequest, setup_recovery};
    use crate::crypto::{FileId, RecoveryKey, WrappedMasterKey, unwrap_master_key_from_recovery};
    ...
    async fn test_rotate_key_file_preserves_x25519_public_key_bytes() {
        ...
        let old_params = argon2_parameters_from_json(&vault.header.argon2_params);
